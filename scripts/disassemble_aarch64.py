...
def run_simulation(out_name, rel_type):
    ...
    if rel_type == 'debug' or rel_type == 'release-debuginfo':
        ...
        cmd.append("-d")
    cmd.append(f"{root_path}/mdp-loop-cloning/out/build/unixlike-armv8-a-clang-{rel_type}/MdpLoopCloning")
...
if __name__ == "__main__":
    ...
    run_simulation(out_name=args.output_name, rel_type=args.rel_type)